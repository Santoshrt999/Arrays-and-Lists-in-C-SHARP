...
namespace CSharpExercises.ArraysAndLists
{
    public class Lists
    {
        ...
        public void Exercise1()
        {
            ...
            while (true)
            {
                ...
                if (String.IsNullorWhiteSpaces(input))
                    break;
            }
        ...
        /// </summary>
        public void Exercie4()
        {
            var Numbers = new List<int>();

            while (true)
            {
                System.Console.WriteLine("Enter a number ot type quit to exit");
                var input = Console.ReadLine();
